...
{if or( $can_edit_node, $has_manage_locations )}
    ...
    <br /><input class="button" type="submit" name="AddSubtreeAssignmentButton" value="{'Add subtree locations'|i18n( 'design/admin/node/view/full' )}" title="{'Add one or more new subtree locations.'|i18n( 'design/admin/node/view/full' )}" style="margin-top:3px" />
    {else}
    ...
    <br /><input class="button-disabled" type="submit" name="AddSubtreeAssignmentButton" value="{'Add subtree locations'|i18n( 'design/admin/node/view/full' )}" title="{'It is not possible to add subtree locations to a top level node.'|i18n( 'design/admin/node/view/full' )}" disabled="disabled" style="margin-top:3px" />
    {/if}
...
{else}
    ...
    <input class="button-disabled" type="submit" name="AddSubtreeAssignmentButton" value="{'Add locations'|i18n( 'design/admin/node/view/full' )}" disabled="disabled" title="{'You cannot add new locations because you do not have permission to edit the current item.'|i18n( 'design/admin/node/view/full' )}" />
    <br /><input class="button-disabled" type="submit" name="AddSubtreeAssignmentButton" value="{'Add subtree locations'|i18n( 'design/admin/node/view/full' )}" disabled="disabled" title="{'You cannot add new subtree locations because you do not have permission to edit the current item.'|i18n( 'design/admin/node/view/full' )}" style="margin-top:3px" />
{/if}
</div>
