...
{else}
    ...
    <br /><input class="button-disabled" type="submit" name="" value="{'Add subtree locations'|i18n( 'design/admin/node/view/full' )}" disabled="disabled" title="{'You cannot add new subtree locations because you do not have permission to edit the current item.'|i18n( 'design/admin/node/view/full' )}" style="margin-top:3px" />
{/if}
</div>
